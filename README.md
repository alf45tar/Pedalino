...
2|Stereo 1/4" TRS ![TRS](https://github.com/alf45tar/Pedalino/blob/master/trs.png)||- 1<sup>st</sup> switch between tip and sleeve
    - 2<sup>nd</sup> switch between ring and sleeve|[Boss FS-7](https://www.boss.info/us/products/fs-7/)
